...
X_train, X_valid, y_train, y_valid = train_test_split(train_data, target, test_size=0.3, random_state = np.random.seed())
...
voting_clf = VotingClassifier(
    estimators=[('lr', log_clf), ('rf', rfc_best), ('svc', svc_best), ('gbm',GBM)],
...
# clf.fit(X_train, y_train)
# print('grdgbm train accuracy:',clf.score(X_train, y_train))
# print('grdgbm valid accuracy:',clf.score(X_valid, y_valid))

# cb=clf.best_params_
# ce = clf.best_estimator_
# print(cb,'\n',ce)
# result = ce.predict(test_data)
